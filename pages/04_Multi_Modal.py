...
with st.sidebar:
    ...
    system_prompt = st.text_area(
        "시스템 프롬프트",
        "You are checking the details of a Bill of Landing. You must summarize Shipper, Consignee, Notify Party, Vessel, Port of Loading, Port of Discharge, Name or Grade of Cargo, API, Date of Issue, Gross Barrels, Gross Metric Tons, Net Barrels, Net Metric Tons",
        height=200,
    )
